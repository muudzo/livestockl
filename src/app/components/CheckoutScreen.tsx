      ...
      <div className="p-4 space-y-6 pb-32">
          ...
          <div className="border rounded-lg p-4 border-primary bg-primary/5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Card, Google Pay, Apple Pay</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex gap-2">
            ...
            <p className="text-sm text-blue-900">You'll be redirected to Stripe's secure checkout page to complete payment.</p>
          </div>
        </div>
      </div>
