      ...
      <div className="p-4 space-y-6 pb-32">
        ...
        <div>
          ...
          <div className="border rounded-lg p-4 border-primary bg-primary/5">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded bg-[#00C3F7] flex items-center justify-center">
                <CreditCard className="w-5 h-5 text-white" />
              </div>
              <div>
                <span className="font-medium">Paystack Checkout</span>
                <p className="text-sm text-muted-foreground">Card, Bank Transfer, Mobile Money</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex gap-2">
            ...
            <p className="text-sm text-blue-900">You'll be redirected to Paystack's secure checkout page to complete payment.</p>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-16 left-0 right-0 bg-card border-t shadow-lg max-w-[480px] mx-auto">
        <div className="p-4 space-y-2">
          ...
          <div className="flex items-center justify-center gap-1 text-xs text-muted-foreground">
            <Lock className="w-3 h-3" /><span>Secured by Paystack</span>
          </div>
        </div>
      </div>
    </div>
