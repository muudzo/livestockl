  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-3">
      ...
      <div className="flex justify-start">
        <div className="max-w-[75%] rounded-2xl rounded-bl-sm bg-slate-200 animate-pulse px-4 py-2">
          <div className="h-4 w-40 bg-slate-300 rounded mb-1" />
          <div className="h-3 w-12 bg-slate-300 rounded" />
        </div>
      </div>
      {/* Own message */}
      <div className="flex justify-end">
        <div className="max-w-[75%] rounded-2xl rounded-br-sm bg-slate-200 animate-pulse px-4 py-2">
          <div className="h-4 w-52 bg-slate-300 rounded mb-1" />
          <div className="h-3 w-12 bg-slate-300 rounded" />
        </div>
      </div>
      {/* Incoming message */}
      <div className="flex justify-start">
        <div className="max-w-[75%] rounded-2xl rounded-bl-sm bg-slate-200 animate-pulse px-4 py-2">
          <div className="h-4 w-64 bg-slate-300 rounded mb-1" />
      ...
      <div className="flex justify-end">
        <div className="max-w-[75%] rounded-2xl rounded-br-sm bg-slate-200 animate-pulse px-4 py-2">
          <div className="h-4 w-36 bg-slate-300 rounded mb-1" />
          <div className="h-3 w-12 bg-slate-300 rounded" />
        </div>
      </div>
    </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {itemTitle && (
                    <p className="text-xs text-emerald-600 truncate">Re: {itemTitle}</p>
                  )}
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="sticky top-0 bg-background z-10 border-b p-4 flex items-center gap-3">
        <button
          ...
          className="shrink-0 w-10 h-10 flex items-center justify-center rounded-full transition-colors duration-200 hover:bg-slate-100"
      ...
      <div className="sticky bottom-16 bg-card border-t p-3">
        <div className="flex gap-2">
          ...
          <Button
            ...
            size="icon"
            className="w-11 h-11 bg-emerald-600 hover:bg-emerald-700 active:scale-90 transition-all duration-200"
