...
export function PaymentStatus() {
  ...
  // Pesepay may append query params on redirect
  const pesepayStatus = searchParams.get('transactionStatus');
  ...
  const getStatus = (): Status => {
    ...
    // Check Pesepay redirect params
    if (pesepayStatus === 'FAILED' || pesepayStatus === 'CANCELLED') return 'failed';
  ...
  const getMessage = () => {
    switch (status) {
      case 'pending': return 'Waiting for Pesepay payment confirmation...';
