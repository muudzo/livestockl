...
const TestPesepayPayment = lazy(() => import('./components/TestPesepayPayment').then(m => ({ default: m.TestPesepayPayment })));
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "test-pesepay",
        element: <ProtectedRoute><LazyLoad><TestPesepayPayment /></LazyLoad></ProtectedRoute>,
      },
      {
        path: "*",
        element: (
