...
const TestPaystackPayment = lazy(() => import('./components/TestPaystackPayment').then(m => ({ default: m.TestPaystackPayment })));
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "test-paystack",
        element: <ProtectedRoute><LazyLoad><TestPaystackPayment /></LazyLoad></ProtectedRoute>,
      },
      {
        path: "*",
        element: (
